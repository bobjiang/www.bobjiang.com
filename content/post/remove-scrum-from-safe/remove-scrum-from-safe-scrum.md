...
![SAFe敏捷团队仅负责部分功能示意图：展示组件团队导致的局部优化问题](/images/scrum1.png)
...
![SAFe多个团队多个PO多个待办列表架构图：对比Scrum单一产品待办列表的差异](/images/scrum2.png)
...
![SAFe程序板示例：展示多个团队之间大量功能依赖关系导致的协调复杂性](/images/scrum3.png)

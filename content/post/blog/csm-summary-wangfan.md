...
![2011年首次尝试Scrum框架的工作总结片段，记录早期Scrum实践经历](images/csm-feedback-640-1.png)
...
![CSM课程前后对Scrum理解的对比图，展示知识框架从零散到系统的转变](images/csm-feedback-640-2.png)

即，课程帮我：

![CSM课程帮助学员实现的三大收获：建立系统框架、填充知识空白、明确实践方向](images/csm-feedback-640-3.png)
...
![Scrum实践与产品管理工作对比图，说明简单框架背后需要关注的无数细节](images/csm-feedback-640-4.png)
...
![Scrum初学者的知识状态图，展示框架空白、缺少条理的学习现状](images/csm-feedback-640-5.png)

知识框架有空白、缺少条理是一方面，欠缺更多的我感觉也许是这些：

![Scrum实践者需要的核心能力图谱，包括引导、教练、冲突管理等软技能](images/csm-feedback-640-6.png)

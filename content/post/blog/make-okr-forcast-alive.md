...
![OKR目标与关键结果概念图，解释Objectives和Key Results的关系和用途](images/okr-img-1.png)
...
![绿色自信笑脸符号，表示完全有信心在季度末完成关键结果](images/okr-1-image-96x96.png)

**绿色自信的笑脸** --完全自信这会发生。我们可以准备市场营销活动。

![橙色担忧笑脸符号，表示可能无法完成需提醒利益相关者](images/okr-2image-1-96x96.png)

**橙色担忧的笑脸** --我们可能做不到，应该提醒利益相关者。

![红色悲伤笑脸符号，表示本季度内无法完成关键结果](images/okr-3image-2.png)

**红色悲伤的笑脸** --没办法。这不会在本季度内发生。不过，我们仍在努力。

![对号符号，表示关键结果已完成交付完成](images/okr-4image-3.png)

**检查** --完成。已交付。做完了。

![停止符号，表示由于优先级变化已停止该工作](images/okr-5image-4-64x64.png)
...
![OKR白板跟踪示例，展示多个关键结果的置信度历史变化趋势](images/OKRSmileys_003.png)
...
![OKR白板跟踪增加完成百分比维度，展示进度和信心水平双重视角](images/OKRSmileys_002.png)
...
![预测扑克计划投票法，团队成员用便利贴估算完成时间范围](images/EstimationVoting.png)
...
![五指投票法展示截止日期置信度，一到五根手指表示信心程度](images/Fist-of-five_001.png)

可以用五个手指进行投票。一根手指代表超级悲观，五根手指超级乐观。三根手指可能意味着紧张。如果信心没有每周增加一次，我们将讨论需要做的事情或摆在我们面前的选择。

![截止日期置信度可视化追踪图，监控每周信心变化趋势](images/okr-image-6.png)

#### **版本的猜测**

一些团队会持续交付，但仍需要与利益相关者和客户沟通进度和期望。他们从产品待办列表中拉取工作加入到Sprint中。

![产品待办列表版本猜测可视化，绿线红线标记信心范围和乐观范围](images/OKR-Smileys_001.png)

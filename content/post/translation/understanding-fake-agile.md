...
![反敏捷漫画图：展示假敏捷现象的讽刺性插图](/images/anti-agile.png)
（上图与腾讯无关，来自我朋友圈的@王宇）
...
![微软敏捷转型历程图：2008-2014年敏捷团队增长趋势](/images/microsoft-journey.png)
...
![敏捷转型停滞图：组织敏捷实施受阻的典型模式](/images/stalled-agile-journey.png)
...
![敏捷方法大全图：数百种敏捷品牌和变体的分类展示](/images/all-agile-methods.png)
...
![SAFe大规模敏捷框架图：规模化敏捷框架的层级结构示意](/images/safe-framework.png)

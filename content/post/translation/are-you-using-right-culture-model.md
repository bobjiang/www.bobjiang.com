...
## 施耐德文化模式？不。
![施耐德文化模式图：控制、协作、培育、胜任四个象限的组织文化分类模型](/images/Schneider-Culture-Model.jpg)
...
## 竞争价值观框架？不。
![竞争价值观框架模型图：组织文化的四象限分类与领导行为关联框架](/images/competing-value-culture.png)
...
## 拉卢文化模式？对！
![拉卢文化模式图：从红色到Teal青色组织的演进阶段与意识层级模型](/images/Laloux-Culture-Model-001.jpg)
...
![拉卢模型意识参与度图：组织意识层级与员工参与度正相关关系示意图](/images/Laloux-Culture-Consciousness-Engagement.png)
...
## Sahota文化模式？是
![Sahota文化模型图：结构与意识双维度组织文化分析框架](/images/Sahota-Culture-Model.jpeg)
